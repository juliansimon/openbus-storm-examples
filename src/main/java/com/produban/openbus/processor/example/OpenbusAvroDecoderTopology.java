...
import com.produban.openbus.processor.function.AvroDecoder;
import com.produban.openbus.processor.spout.OpenbusBrokerSpout;

public class OpenbusAvroDecoderTopology {	
	private static Logger LOG = LoggerFactory.getLogger(OpenbusAvroDecoderTopology.class);
	...
	public static StormTopology buildTopology() {		
		...
		Stream documentStream = topology.newStream("spout1", openbusBrokerSpout.getPartitionedTridentSpout())
        		.each(new Fields("bytes"), new AvroDecoder(), new Fields("postBytes"));
