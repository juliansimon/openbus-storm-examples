 ...
 */
public class ParseJSONLogHour extends BaseFunction {

	private static Logger LOG = LoggerFactory.getLogger(ParseJSONLogHour.class);    
    ...
    public final void execute(final TridentTuple tuple, final TridentCollector collector) {        
        try {
            ...
            String user = FormatUtil.getRequestFormat(json.getString("user"));
